...
const SellVehicleScreen: React.FC = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView>
               <View style={tw`flex-row items-center bg-white rounded-full px-4 py-2 mx-2 shadow-lg`}>
                    {/* Search Icon */}
                    <TouchableOpacity onPress={handleSearch}>
                        <FontAwesome5 name="search" size={18} color="#154CE4" />
                    </TouchableOpacity>
                    ...
                    {/* Vehicle Type Picker */}
                    <View style={tw`bg-white rounded-xl mx-2 my-2 shadow-lg`}>
                    <Picker
                    ...
                    filteredVehicles.map((vehicle, index) => (
                        <View key={index} style={styles.card}>
                           ...
                           <View style={tw`p-3`}>
                               ...
                               <View style={tw`rounded-md p-2 border-gray-300 border`}>
                                    ...
                                    {vehicle.type === "BUS" && <>
                                        <View style={tw`flex-row mb-0.5 border-b border-gray-200 pt-3.5 flex-wrap gap-1`}
                                        >
                                        ...
                                        <Text style={tw`border border-gray-300 p-2 rounded-xl`}>{vehicle?.sellDescription || "No Description"}</Text>
                                    </>}
                           </View>
                        </View>
                    ))
